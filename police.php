...
<div class="infobox">
    <div>
        <div class="infotop grid">
            <div>
                <h3>Police Livery</h3>
                <p>All Lothian Police Service vehicles use the same livery, except for Stealth units which use a darkened version. Livery pieces (side, front, back, text, etc) and already painted cars can be found on AmeerSixtySeven's Creative Hub in game.</p>
            </div>
